package com.nature.edu.util.redis;
...
public class RedissonRLock {
	 ...
	 */
	public void atomic(RunnableThrowsException operation, long waitTime, long leaseTime) {
	 ...
	 */
	public <T> T atomic(CallableThrowsException<T> operation, long waitTime, long leaseTime) {
		boolean isLock = false;
		T t = null;
		try {
			// 加锁
	 ...
	 */
	public void atomic(RunnableThrowsException operation) {
